...
function queryRecord(days){
    ...
    $.ajax({
        ...
        success: function (data) {
            layer.closeAll();
            var data = eval(data).data;
            $("#statistic-record-ul").empty();
            $("#statistic-record-table").children("tbody").empty();
            $.each(data, function (index, value) {
                ...
                var tr = "<tr>"+
                    ...
                    "</td>" +
                    "</tr>";
                $("#statistic-record-ul").append(content);
                $("#statistic-record-table").children("tbody").append(tr);
            })
            var more = "<li class=\"layui-timeline-item\">"+
                ...
                "</li>"
            $("#statistic-record-ul").append(more);
        }, error: function () {
            layer.closeAll();
            layer.msg("数据加载请求失败！");
        }
